...
from gen import augment, pseudodocs, pseudodocs_vae
...
def train_word2vec(sentence_matrix, vocabulary_inv, dataset_name, mode='skipgram',
    ...
    model_dir = './datasets/' + dataset_name
...
if __name__ == "__main__":
    ...
    parser.add_argument('--beta', default=300, type=int)
    ...
    if args.trained_weights is None:
        ...
        seed_docs, seed_label = pseudodocs_vae(word_sup_array, gamma, background_array,
                                           sequence_length, len_avg, len_std, beta, alpha, 
                                           vocabulary, vocabulary_inv, embedding_mat, args.model, 
                                           './westclass/results/{}/{}/phase1/'.format(args.dataset, args.model))
        ...
        wstc.pretrain(x=seed_docs, pretrain_labels=seed_label,
                     ...
                     save_dir='./westclass/results/{}/{}/phase2'.format(args.dataset, args.model))
        ...
        y_pred = wstc.fit(x, y=y, tol=delta, maxiter=args.maxiter, batch_size=args.batch_size,
                         update_interval=update_interval, save_dir='./westclass/results/{}/{}/phase3'.format(args.dataset, args.model), 
    ...
    print("\n### Generating outputs ###")
    write_output('./datasets/' + args.dataset, y_pred, perm)